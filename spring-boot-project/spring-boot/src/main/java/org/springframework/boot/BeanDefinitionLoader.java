...
class BeanDefinitionLoader {
	/**
	 * 资源文件，这里主要是@SpringBootApplicationContext的类
	 */
	private final Object[] sources;
	/**
	 * 注解的BeanDefinition读取器 AnnotatedBeanDefinitionReader
	 */
	 ...
	 * @param registry AnnotationConfigServletWebServerApplicationContext
	 * @param sources 主要是@SpringBootApplication
	 */
	BeanDefinitionLoader(BeanDefinitionRegistry registry, Object... sources) {
		...
		//将拥有@SpringBootApplication的排除在扫描外
	...
	public int load() {
		int count = 0;
		//遍历拥有@SpringBootApplication注解的类
	...
	/**
	 * 加载配置
	 * @param source 拥有@SpringBootApplication注解的类
	 * @return
	 */
	...
	/**
	 * 加载拥有@SpringBootApplication注解的类
	 * @param source
	 * @return
	 */
	private int load(Class<?> source) {
		...
		if (isComponent(source)) {
			//注册启动类，对应的BeanDefinition是AnnotatedGenericBeanDefinition
			//对应的metadata是StandardAnnotationMetadata
