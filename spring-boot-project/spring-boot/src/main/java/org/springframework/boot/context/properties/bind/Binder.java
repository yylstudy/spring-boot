...
public class Binder {
	...
	/**
	 * 配置类ConfigurationPropertySource
	 * SpringIterableConfigurationPropertySource
	 */
	private final Iterable<ConfigurationPropertySource> sources;
	/**
	 * 占位符解析器 PropertySourcesPlaceholdersResolver
	 */
	...
	/**
	 * 创建一个绑定器
	 * @param sources SpringIterableConfigurationPropertySource
	 * @param placeholdersResolver PropertySourcesPlaceholdersResolver PropertySource的占位符解析器
	 */
	public Binder(Iterable<ConfigurationPropertySource> sources,
	 ...
	 * @param sources SpringIterableConfigurationPropertySource
	 * @param placeholdersResolver PropertySourcesPlaceholdersResolver PropertySource的占位符解析器
	 * @param conversionService null
	 * @param propertyEditorInitializer null
	 */
	public Binder(Iterable<ConfigurationPropertySource> sources,
			PlaceholdersResolver placeholdersResolver,
			ConversionService conversionService,
