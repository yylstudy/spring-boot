...
class OnBeanCondition extends SpringBootCondition implements ConfigurationCondition {
	...
	/**
	 *
	 * @param context ConditionContextImpl
	 * @param metadata
	 * @return
	 */
	@Override
	...
	private static class BeanSearchSpec {
		...
		/**
		 * 注解的type方法的值 ，如果是@Bean注解就是@Bean注解方法的返回类型
		 */
		...
		/**
		 * 添加推导的BeanType
		 * @param context 条件上下文ConditionContextImpl
		 * @param metadata 元数据
		 * @param beanTypes
		 */
