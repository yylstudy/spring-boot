...
class OnPropertyCondition extends SpringBootCondition {
	 ...
	 * @param metadata @Configuration所在类的元数据
	 * @return
	 */
	@Override
	...
	/**
	 * 确定输出条件
	 * @param annotationAttributes ConditionalOnProperty注解属性对象
	 * @param resolver
	 * @return
	 */
	...
	private static class Spec {
		/**
		 * 注解方法 prex的值 spring.aop.
		 */
		private final String prefix;
		/**
		 * 注解方法havingValue的值 true
		 */
		...
		private void collectProperties(PropertyResolver resolver, List<String> missing,
			...
			for (String name : this.names) {
				...
				//环境中是否包含对应的key，这里的aop 就是 spring.aop.auto 这个配置
